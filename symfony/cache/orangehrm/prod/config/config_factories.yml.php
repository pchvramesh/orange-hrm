...
// date: 2019/01/18 07:48:22
  ...
  'cache_dir' => '/opt/bitnami/apps/orangehrm/htdocs/symfony/cache/orangehrm/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/opt/bitnami/apps/orangehrm/htdocs/symfony/apps/orangehrm/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'ohrmPatternRouting');
      $cache = null;
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('PHPSESSID'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/opt/bitnami/apps/orangehrm/htdocs/symfony/cache/orangehrm/prod/template',
  'lifetime' => 86400,
  'prefix' => '/opt/bitnami/apps/orangehrm/htdocs/symfony/apps/orangehrm/template',
)));
